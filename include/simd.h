...
void f32_add_x(f32* a, f32 x, const size_t size);
void f32_sub_x(f32* a, f32 x, const size_t size);
void f32_mul_x(f32* a, f32 x, const size_t size);
void f32_div_x(f32* a, f32 x, const size_t size);
